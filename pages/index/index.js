...
Page({
    ...
    wx.login({
      success: res => {
        ...
        utils.requestPromise('wx/login', obj, 'POST', '登录中')
          .then(res => {
            console.log(res.header.third_session)
  ...
  addressResolution(latitude, longitude) {
    var map = new QMap({
      key: 'CXRBZ-T52W3-YK33L-YGOH3-RUPGO-DLBL5'
    })
    map.reverseGeocoder({
      location: {
        latitude: latitude,
